...
2. **Criterio de Inclusión:** Para ambos periodos (2012 y 2024), la base de datos ha sido filtrada para incluir **únicamente viviendas particulares**. 
3. **Ejecución:** Descargue los archivos `.do` (Stata) de este repositorio y ejecútelos en el orden indicado para procesar las variables y generar el componente principal (PCA).
